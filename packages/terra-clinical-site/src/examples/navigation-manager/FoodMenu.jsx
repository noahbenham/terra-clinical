  ...
  render() {
    ...
    const headerButtons = (
      <div>
        ...
        {<Button text="Burgers" onClick={this.handleUpdate({ selectedContent: 'BURGERS' })} isBlock icon={<IconProjects />} />};
        {<Button text="Drinks" onClick={this.handleUpdate({ selectedContent: 'DRINKS' })} isBlock icon={<IconProjects />} />};
      </div>
    );
