...
const SmartConsumer = ({
  ...
  // const src = `https://smart.devcerner.com/smart/2c400054-42d8-4e74-87b7-80b5bd5fde9f/apps/a77a3d9a-28fe-4822-a96a-2ff09bed599a?PAT_PersonId=${patientId}&USR_PersonId=${userId}&PAT_PPRCode=${pprCode || '1116'}&username=${userName}&need_patient_banner=true`;
